      ...
      <div id='home-container'>
        <div className='staticImg-container'>
          <div className='firstStatic'>
            <img className='staticImgFirst' src={"https://imageio.forbes.com/specials-images/imageserve/637b1d11729a96ce28ea598c/0x0.jpg?format=jpg&width=1200"} alt="loading Image" />
          </div>
